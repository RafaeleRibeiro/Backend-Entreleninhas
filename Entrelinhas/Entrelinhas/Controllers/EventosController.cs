...
namespace Entrelinhas.Controllers
{
    ...
    public class EventosController : ControllerBase
    {
        ...
        [HttpGet("/buscarPorData/{dataEvento}")]
        public async Task<IActionResult> BuscarPorData(string dataEvento)
        {
            var listaEventos = await _context.Eventos.Where(e => e.Data.ToString().Contains(dataEvento)).ToListAsync();
